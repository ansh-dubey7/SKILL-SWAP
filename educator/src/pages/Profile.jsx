...
//           <div className="flex justify-center md:justify-start">
//             <div className="w-32 h-32 bg-gray-700 rounded-full flex items-center justify-center text-4xl font-bold text-white transform hover:scale-110 transition duration-300">
//               {profileData?.emailOrPhone.charAt(0).toUpperCase() || "U"}
//             </div>
//           </div>
//           <div className="space-y-4">
//             <div>
...
//           <button
//             className="px-6 py-3 bg-[#3b82f6] text-white font-semibold rounded-lg hover:bg-blue-600 transition duration-300 transform hover:scale-105"
