...
//       </div> */}
//       <div className='relative z-10 flex flex-col items-center min-h-screen pt-40 md:pt-[20rem] lg:pt-72 text-center'>
//         <h1 className="text-[1.625rem] md:text-[3.5rem] font-bold text-white max-w-6xl">Become a<span className="bg-gradient-to-b md:text-[3.5rem] from-[#7dd3fc] to-[#3b82f6] bg-clip-text text-transparent text-[1.375rem] italic font-normal leading-[120%]">Code Commander</span>
//         </h1>
...
//         <div className='mt-10 md:mt-16 w-full max-w-[800px] h-[60vh] mx-auto px-4'>
//             <img src={assets.hero5} alt="" className='border-t-[4px] border-l-[4px] border-r-[8px] border-blue-900 
//              rounded-t-3xl w-full h-auto shadow-lg shadow-gray-500'/>
//         </div>
//       </div>
//     </div>
//   )
